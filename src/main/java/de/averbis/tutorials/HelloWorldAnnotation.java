...
public class HelloWorldAnnotation extends Annotation {
  ...
  public final static int typeIndexID = JCasRegistry.register(HelloWorldAnnotation.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected HelloWorldAnnotation() {/* intentionally empty block */}
   ...
   */
  public HelloWorldAnnotation(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public HelloWorldAnnotation(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
  ...
  /** getter for greeting - gets The greeting of the HelloWorldAnnotation
   * @generated
